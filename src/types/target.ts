...
export const LANGUAGE_METADATA: Record<Language, LanguageMetadata> = {
  ...
  rust: {
    ...
    defaultVersion: '1.75',
    availableVersions: ['1.74', '1.75', '1.76'],
    frameworks: ['axum'],
    icon: 'rust',
  },
  csharp: {
...
export const FRAMEWORK_METADATA: Record<Framework, FrameworkMetadata> = {
  ...
  fastapi: {
    label: 'FastAPI',
    language: 'python',
    defaultVersion: '0.110',
    availableVersions: ['0.109', '0.110', '0.111'],
