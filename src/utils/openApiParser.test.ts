...
describe('openApiParser', () => {
  ...
  describe('parseContent', () => {
    ...
    it('should handle YAML with anchors and aliases', () => {
      const yamlWithAnchors = `openapi: "3.0.3"
info:
  title: Test
  version: "1.0"
components:
  ...
  describe('parseOpenApi', () => {
    ...
    it('should create Email validation for email format', () => {
      ...
      const emailValidation = emailField?.validations.find((v) => v.type === 'Email');
    ...
    it('should add NotNull validation for required fields', () => {
      ...
      const notNullValidation = emailField?.validations.find((v) => v.type === 'NotNull');
    ...
    it('should create relations from $ref', () => {
      ...
      const bookToAuthor = result.relations.find((r) => r.sourceFieldName === 'author');
    ...
    it('should create OneToMany relations from array $ref', () => {
      ...
      const libraryToBooks = result.relations.find((r) => r.sourceFieldName === 'books');
...
components:
  schemas:
    Phone:
      ...
      const patternValidation = field?.validations.find((v) => v.type === 'Pattern');
